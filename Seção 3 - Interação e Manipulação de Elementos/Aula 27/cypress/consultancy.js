describe("Formulário de Consultoria", () => {
  it("Deve solicitar consultoria individual", () => {
    ...
    // cria um array com todas as tecnologias
    const techs = [
        'Cypress',
        'Selenium',
        'WebDriverIO',
    ...
    // cria um forEach para incluir uma tecnologia por vez
    techs.forEach((tech) => {
            cy.get(
              'input[placeholder="Digite uma tecnologia e pressione Enter"]'
            )
              .type(tech)
              .type("{enter}");
